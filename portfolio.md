...
- description: Architected a complete navigation framework for an offroad skid-steer JCB vehicle. Developed custom path planners, route trackers, and robust motion controllers for unstructured environments.
- stack: Skid_Steer, Path_Planners, Route_Tracking, C++

### 2.5D Map Fusion & SLAM
- category: navigation
- scene: points
- company: Novus & Acceleration Robotics
- description: Created probabilistic, evidential, and context-based gridmap fusion frameworks. Implemented multi-sensor mapping utilizing Laser, Camera, and Radar datasets on ground vehicles.
- stack: 2.5D_Mapping, Gridmap_Fusion, Radar_CV_Laser, ROS

### Drone Autonomy & OS Stack
- category: drones
- scene: flight
- company: Exadatum & Acceleration Robotics
- description: Built a dockerized ROS OS for PX4/ArduPilot flight controllers. Developed behavioral landing systems, geo-fencing, I2C streaming packages, and WebSocket APIs with offline synchronization capabilities.
- stack: PX4_Ardupilot, Behavior_Trees, Mavros, AWS_IoT

### Fleet Management & Dispatch
- category: fleets
- scene: coverage
- company: Acceleration Robotics
- description: Created custom scheduling and dispatch systems for agricultural and industrial robots. Integrated multiple robots dynamically inside Gazebo and managed operations using OpenRMF and ROS2.
- stack: OpenRMF, ROS2, BehaviorTrees_CPP, Gazebo

### Sport Medical Mechatronic Devices
- category: manipulation
- scene: tokens
- company: Futuring Design
- description: Researched and built proof-of-concepts for mechatronic sport-medical devices. Developed geometric/kinematic posture-correction algorithms, GUI firmware, and AWS data pipelines.
...
- description: Specialization in automation, control systems, signal processing, modelling, and dynamic physical simulations.

### B.Tech in Mechanical Engineering
- date: 2015 — 2018
- organization: University of Pune · Pune, India
